...
const apiURL =
  "////api.openweathermap.org/data/2.5/forecast?q=Soda Springs,ID,US&appid=84297c2a0a0b88e4f791efca7bb46439&units=imperial";
...
const currentapiURL =
  "//api.openweathermap.org/data/2.5/weather?id=5607916&APPID=84297c2a0a0b88e4f791efca7bb46439&units=imperial";
fetch(currentapiURL)
  .then((response) => response.json())
  .then((weatherInfo) => {
    console.log(weatherInfo);
